...
namespace ContractOrganizer.Controllers
{
    public class AttendancesController : Controller
    {
        ...
        public AttendancesController(ContractOrganizerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,dTime")] Attendance attendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,dTime")] Attendance attendance)
        {
            if (id != attendance.id)
            {
                return NotFound();
