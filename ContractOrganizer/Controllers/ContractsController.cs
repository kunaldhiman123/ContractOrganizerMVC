...
namespace ContractOrganizer.Controllers
{
    public class ContractsController : Controller
    {
        ...
        public ContractsController(ContractOrganizerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Company,dTime")] Contract contract)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Company,dTime")] Contract contract)
        {
            if (id != contract.id)
            {
                return NotFound();
